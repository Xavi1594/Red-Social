...
describe('RegisterFormComponent', () => {
  it('renders the registration form', () => {
    ...
    // Realiza afirmaciones sobre el componente renderizado
  });
  ...
  it('allows the user to enter input and submit the form', () => {
    ...
    // Realiza afirmaciones sobre los cambios esperados después de la interacción
  });
  ...
  it('displays an error message for invalid email', () => {
    ...
    // Realiza afirmaciones sobre el mensaje de error esperado
  });
  ...
  // Agrega más pruebas para otros campos y validaciones aquí
